...
if($_SESSION['is_adminlogin']){
    ...
    $selectquery="select * from payment_tb";
...
<li class="nav-item"><a class="nav-link" href="trainerinfo.php">Trainer Information</a></li>
<li class="nav-item"><a class="nav-link" href="paymentinfo.php">Payment Information</a></li>
...
<div class="card">
    ...
    <a href="dashboard.php" class="btn btn-light">Go Back</a>
             ...
             <div class="col-md-3" ><h3>Payment Details</h23></div>
     ...
     <tr>
        ...
        ?>
           <tr>
                ...
                <td><?php echo $res['p_email']; ?></td> 
                <td><?php echo $res['p_amount'];?></td>
                <td><?php echo $res['p_mode'];?></td>
